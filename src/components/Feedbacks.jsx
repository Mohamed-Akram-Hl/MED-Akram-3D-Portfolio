...
const FeedbackCard = ({index, testimonial, name, designation, company, image}) => (
  <motion.dev variants = {fadeIn("","spring", index*0.5,0.75)} className='bg-black-200 p-10 rounded-3xl xs:w-[320px] w-full'>
...
const Feedbacks = () => {
  return (
    <div className="mt-12 bg-black-100 rounded-[20px]">
      ...
      <div className={`${styles.padding} -mt-20 pb-14 flex justify-center flex-wrap gap-7`}>
