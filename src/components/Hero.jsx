...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto">
      ...
      <ComputersCanvas/>
      <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }} transition={{ type: "spring", stiffness: 400, damping: 10 }} className="absolute xs:bottom-10 bottom-10 w-full flex justify-center items-center">
        <a href="#about">
